...
**Project**: confetti-burst-party 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A page showing confetti when you press a button 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/confetti-burst-party.git
cd confetti-burst-party
npm i
